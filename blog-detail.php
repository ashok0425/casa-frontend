...
<section class="innerBanner--section" style="background: url('/img/contact-banner-bg.png')center center no-repeat; background-size:cover;">
    <div class="container">
        <div class="innerBanner--text">
            <h1>FAQs about Travel to Nepal</h1>
        </div>
    </div>
</section>
<!-- Inner Banner Section -->
<!-- Blog Detail Section -->
<section class="blogDetail--section padding">
    <div class="container">
...
<section class="general--section padding dimBg">
    <div class="container">
        <div class="general--box">
            <h2>Similar Blogs</h2>
            <div class="sliderBox">
                <div class="blog--slider splide" id="blog--slider">
                    <div class="splide__slider">
                        <div class="splide__track">
                            <div class="splide__list">
                                <?php for ($i = 0; $i < 4; $i++) { ?>
                                    <div class="splide__slide">
                                        <?php include 'includes/components/blog-item.php'; ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
